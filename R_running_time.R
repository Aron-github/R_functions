# measuring R execution time
# derived from: http://www.alexejgossmann.com/benchmarking_r/
...
# EXAMPLE TO COMPARE LINEAR REGRESSION COMPUT-TIME
set.seed(2017)
n <- 10000
p <- 100
